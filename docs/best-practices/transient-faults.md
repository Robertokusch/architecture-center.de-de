...
- [Trennschalter-Muster](../patterns/circuit-breaker.md)
- [Muster „Kompensierende Transaktion“](../patterns/compensating-transaction.md)
- [Idempotency Patterns][idempotency-patterns] (Muster der Idempotenz)
