...
ms.locfileid: "54482306"
---
# <a name="horizontal-vertical-and-functional-data-partitioning"></a>Horizontale, vertikale und funktionale Datenpartitionierung
...
- Das [Sharding-Muster](../patterns/sharding.md) beschreibt einige allgemeine Strategien für das Sharding von Daten.

- Das [Indextabellenmuster](../patterns/index-table.md) zeigt das Erstellen von sekundären Indizes für Daten. Mit diesem Ansatz kann eine Anwendung Daten durch Abfragen, die nicht auf den Primärschlüssel einer Sammlung verweisen, schnell abrufen.

- Das [Muster für materialisierte Sichten](../patterns/materialized-view.md) erläutert, wie Sie vorab aufgefüllte Ansichten generieren können, die Daten zusammenfassen, um schnelle Abfragevorgänge zu unterstützen. Dieser Ansatz kann in einem partitionierten Datenspeicher hilfreich sein, wenn die Partitionen, die die Daten enthalten, die zusammengefasst werden, über mehrere Standorte verteilt sind.
