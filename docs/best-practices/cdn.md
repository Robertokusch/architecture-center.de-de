...
description: Anleitung zur Verwendung von Content Delivery Networks (CDNs) für die Bereitstellung von in Azure gehosteten Inhalten mit hoher Bandbreite
author: dragon119
ms.date: 02/02/2018
...
ms.locfileid: "58249105"
---
# <a name="content-delivery-networks-cdns"></a>Content Delivery Networks (CDNs)
...
In diesem Thema werden einige allgemeine bewährte Methoden und Aspekte zur Verwendung eines CDN beschrieben. Weitere Informationen finden Sie unter [Azure CDN](/azure/cdn/).
