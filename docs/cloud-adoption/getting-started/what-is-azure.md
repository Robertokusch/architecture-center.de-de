...
---
# <a name="enterprise-cloud-adoption-how-does-azure-work"></a>Enterprise Cloud-Einführung: Wie funktioniert Azure?
...
Nachdem Sie sich jetzt mit der internen Funktionsweise von Azure vertraut gemacht haben, können Sie sich über die [Kontrolle des Ressourcenzugriffs](what-is-governance.md) informieren. 
