            ...
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card">
                        ...
                        <div class="cardText">
                            <h3>Framework für die Einführung der Microsoft Cloud (Microsoft Cloud Adoption Framework)</h3>
                            <p>Ein Prozess zum Erstellen einer organisationsweiten Strategie für die Einführung der Cloud, bei dem die Schwerpunkte auf Richtlinien, Governance und Infrastruktur liegen.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card">
                        ...
                        <div class="cardText">
                            <h3>High Performance Computing (HPC) in Azure</h3>
                            <p>Entwurfsleitfaden und Komponenteninformationen für die Erstellung von HPC-Anwendungen (High Performance Computing) in Azure.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card">
                        ...
                        <div class="cardText">
                            <h3>Übermitteln Ihrer Ideen für das Architecture Center</h3>
                            <p>Haben Sie Ideen für neue Architektur- oder Entwurfsdokumentationen?</p>
                            <p>Welche Arten von Artikeln sollen Ihrer Meinung nach ins Azure Architecture Center aufgenommen werden?</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Übersicht über eine n-schichtige Architektur</h3>
                    </div>
                </div>
            </div>
        </div>
