...
5. Wählen Sie unter **Rolle** die Option **Besitzer** aus.
6. Geben Sie die E-Mail-Adresse des Benutzers ein, den Sie als Besitzer hinzufügen möchten.
7. Wählen Sie den Benutzer aus, und klicken Sie auf **Speichern**.
...
2. Führen Sie „Setup-KeyVault.ps1“ wie folgt erneut aus:
...
1. Führen Sie „Setup-KeyVault.ps1“ wie folgt aus:
...
3. Führen Sie „Setup-KeyVault.ps1“ erneut aus, um die Datenbankverbindungszeichenfolge hinzufügen:
...
* `AzureAd:WebApiResourceId`: Der App-ID-URI, den Sie angegeben haben, als Sie die Anwendung „Surveys.WebAPI“ in Azure AD erstellt haben.
...
* `KeyVault:Name`: Der Name Ihres Schlüsseltresors.
