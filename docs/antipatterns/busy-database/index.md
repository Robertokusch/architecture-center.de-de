...
Es verwendet Transact-SQL-Funktionen, um die Daten zu analysieren und die Ergebnisse zu XML zu konvertieren. Das vollständige Beispiel finden Sie [hier][sample-app].
