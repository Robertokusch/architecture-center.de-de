...
- [Service Fabric](https://docs.microsoft.com/en-us/azure/service-fabric/service-fabric-overview) ist eine Plattform für die Entwicklung und das Hosting skalierbarer [Microservicelösungen](/azure/service-fabric/service-fabric-overview-microservices).
