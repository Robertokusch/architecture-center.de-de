...
description: Verstehen und Entwerfen robuster, hoch verfügbarer, fehlertoleranter Anwendungen und Planen der Notfallwiederherstellung.
author: adamglick
ms.date: 08/18/2016
ms.topic: article
...
ms.locfileid: "59640565"
---
# <a name="recover-from-a-region-wide-service-disruption"></a>Wiederherstellung nach einer regionsweiten Dienstunterbrechung
...
- **Warmspare (aktiv/passiv):** Ein sekundärer gehosteter Dienst wird in einer alternativen Region erstellt, und Rollen werden bereitgestellt, um eine Mindestkapazität zu gewährleisten. Die Rollen empfangen jedoch keinen Produktionsdatenverkehr. Diese Vorgehensweise eignet sich für Anwendungen, die nicht dafür entworfen wurden, Datenverkehr über Regionen hinweg zu verteilen.
...
### <a name="geo-replication-pricing"></a>Preise für die Georeplikation
...
Azure SQL-Datenbank stellt zwei Arten von Wiederherstellung bereit: Geowiederherstellung und aktive Georeplikation.
