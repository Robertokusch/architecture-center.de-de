...
---
# <a name="data-considerations-for-microservices"></a>Überlegungen zu Daten für Microservices
...
## <a name="example-choosing-data-stores-for-the-drone-delivery-application"></a>Beispiel: Auswählen von Datenspeichern für die Drohnenlieferungsanwendung

In den vorherigen Artikeln dieser Reihe wird ein Drohnenlieferdienst als Beispiel herangezogen. Weitere Informationen zum Szenario sowie die entsprechende Referenzimplementierung finden Sie [hier](./index.md).
