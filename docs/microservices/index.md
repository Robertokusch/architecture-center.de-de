...
![Diagramm eines Drohnenlieferdiensts](./images/drone.svg)
...
Der Gesamtfokus liegt auf einem End-to-End-Szenario: Einem Drohnenlieferdienst, mit dem Kunden Termine für Pakete festlegen können, die dann per Drohne abgeholt und zugestellt werden. Den Code unserer Referenzimplementierung finden Sie auf GitHub.
