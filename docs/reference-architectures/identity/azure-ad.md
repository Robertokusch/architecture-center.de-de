---
title: Integrieren lokaler AD-Domänen in Azure AD
titleSuffix: Azure Reference Architectures
description: Implementieren Sie eine sichere hybride Netzwerkarchitektur mit Azure Active Directory (Azure AD).
author: telmosampaio
ms.date: 11/28/2016
ms.custom: seodec18
...
![Cloudidentitätsarchitektur mit Azure Active Directory](./images/azure-ad.png)
...
Sie können auch Ihre eigenen Filter definieren, um die zu synchronisierenden Objekte nach Domäne oder Organisationseinheit zu begrenzen. Alternativ können Sie komplexere benutzerdefinierte Filter implementieren, wie unter [Azure AD Connect-Synchronisierung: Konfigurieren der Filterung][aad-filtering] beschrieben.
...
Weitere Informationen zur Einrichtung eines hochverfügbaren Azure AD Connect-Synchronisierungsservers sowie zur Wiederherstellung nach einem Ausfall finden Sie unter [Azure AD Connect Sync: Operative Aufgaben und Überlegungen – Notfallwiederherstellung][aad-sync-disaster-recovery].
