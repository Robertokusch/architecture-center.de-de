...
description: Erfahren Sie, wie Sie eine sichere hybride Netzwerkarchitektur mit Active Directory-Verbunddienst-Autorisierung in Azure implementieren.
author: telmosampaio
ms.date: 11/28/2016
ms.custom: seodec18
